...
public class SpecterDebugClient implements ClientModInitializer {
	private static void addMetatagLine(List<Text> lines, String key, Object... values) {
		lines.add(Text.translatable("tooltip.metatag." + key).formatted(Formatting.DARK_PURPLE));
		lines.add(Text.translatable("tooltip.metatag." + key + ".text", values).formatted(Formatting.BLUE));
	}
